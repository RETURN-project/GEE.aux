...
# plot the blocks
png(file.path(ifolder, 'folds_YrYr.png'), width = 700, height = 550)
plot(folds)
dev.off()
```
...
```{r brt_yryr}
names_covars <- c('TCmean5000', 'Elev', 'Slope','Nitro_000_030','CEC_000_030','SOC_000_030', 'CWD','Pseas','MAP','impact','Vpre', 'pop10000', 'distRoads')
...
grid<-expand.grid(.n.trees=seq(1000,1500,by=500),.interaction.depth=seq(1,5,by=2),.shrinkage=c(.01,.1), bag.fraction = c(0.5,0.75), .n.minobsinnode=10)
...
# ---------------------------------------------------------
# ---------------------------------------------------------
names_covars_part <- c('TCmean5000', 'Elev', 'Slope','Nitro_000_030','CEC_000_030','SOC_000_030', 'CWD','Pseas','MAP', 'pop10000', 'distRoads')
...
dat_covar <- total_val[names_covars]
# plot marginal effects
png(file.path(ifolder, 'marEffect_brt_R80P.png'), width = 1200, height = 300)
plot_BRT_hist(mod_brt,dat_covar, names_covars, names_covars_short)
dev.off()
# evaluate interaction effects
...
dat_covar <- total_val[names_covars_part]
# assess variable importance 
png(file.path(ifolder, 'mod_brt_part_R80P.png'), width = 700, height = 1500)
summary(mod_brt_part)
dev.off()
# plot marginal effects
png(file.path(ifolder, 'marEffect_brt_part_R80P.png'), width = 1200, height = 300)
plot_BRT_hist(mod_brt_part,dat_covar, names_covars_part, names_covars_short_part)
dev.off()
